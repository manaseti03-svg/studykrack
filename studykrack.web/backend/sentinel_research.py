...
def marksman_agentic_loop(query_str, gemini_model, embed_model, db, check_quota_func):
    ...
    try:
        ...
        - Priority 1: Use the retrieved Vault Data provided below.
        - Priority 2: If the Vault Data is missing or insufficient for a 14-mark answer, use your internal 'Global Sentinel' knowledge.
        - Clearly state the source in your analysis.
        - DO NOT invent facts, but ensure a complete 14-mark structured response.
